layui.define(['jquery', 'layer', 'form', 'element', 'upload', 'code', 'face'], function (exports) {
    ...
    var renderer = window.markdownit({
        ...
        highlight: function (str, lang) {
            return '<pre class="line-numbers"><code class="language-' + lang + '">' + easyeditor.escape(str) + '</code></pre>';
        }
    });
    ...
    var easyeditor = {
        init: function (options) {
            var html = ['<div class="layui-unselect fly-edit ' + (options.style === "fangge" ? "easyeditor-fangge" : "") + '" >',
                '<span type="face" title="插入表情"><i class="iconfont icon-expressions" style="top: 1px;"></i></span>',
                '<span type="picture" title="插入图片：img[src]"><i class="iconfont icon-image"></i></span>',
                '<span type="href" title="超链接格式：a(href)[text]"><i class="iconfont icon-link"></i></span>',
                '<span type="code" title="插入代码"><i class="iconfont icon-code" style="top: 1px;"></i></span>',
                '<span type="yinyong" title="引用"><i class="iconfont icon-quote"></i></span>',
                '<span type="ul" title="无序列表"><i class="iconfont icon-unorderedList"></i></span>',
                '<span type="ol" title="有序列表"><i class="iconfont icon-orderedList"></i></span>',
                '<span type="table" title="表格"><i class="iconfont icon-table"></i></span>',
                '<span type="hr" title="分割线"><i class="iconfont icon-hr"></i></span>',
                '<span type="save" title="保存"><i class="iconfont icon-baocun"></i></span>',
                '<span type="yulan" title="预览"><i class="iconfont icon-preview"></i></span>',
                '<span type="fullScreen" title="全屏"><i class="iconfont icon-fullScreen"></i></span>',
                '</div>'
            ].join('');
            ...
            var log = {},
                mod = {
                            ...
                            success: function (layero, index) {
                                ...
                                upload.render({
                                    ...
                                    headers: options.headers,
                                        ...
                                        if (res.code === (options.uploadResultCode || 0)) {
                                            image.val(options.uploadResultUrl + res.data);
                                        } else {
                                            layer.msg(res[options.uploadResultMsg], {
                                                icon: 5
                                            });
                                        }
                                    }
                    ...
                    fullScreen: function (editor, span) { //全屏
                        ...
                        othis.html('<i class="iconfont icon-tuichuzhuanhuan"></i>');
                    ...
                    save: function(editor, span){
                        typeof options.save === 'function' && options.save(editor);
                    },
                    exitScreen: function (editor, span) { //退出全屏
                        var othis = $(span);
                        othis.attr("type", "fullScreen");
                        othis.attr("title", "全屏");
                        othis.html('<i class="iconfont icon-fullScreen"></i>');
                        var ele = document.documentElement
                    ...
                    yulan: function (editor, span) { //预览
                        ...
                        mod.yulan.index = layer.open({
                            ...
                            success: function (layero) {
                                ...
                                var layuiCode = options.codeStyle === 'layuiCode';
        ...
        content: function (content) {
            return renderer.render(easyeditor.escape(content || '') //xss
                .replace(/  \n/g, "<br>")//强制换行
